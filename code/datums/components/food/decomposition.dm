...
#define DECOMPOSITION_TIME (20 MINUTES) // bobaEDIT CHANGE - ORIGINAL: #define DECOMPOSITION_TIME (10 MINUTES)
#define DECOMPOSITION_TIME_RAW (15 MINUTES) // bobaEDIT CHANGE - ORIGINAL: #define DECOMPOSITION_TIME_RAW (5 MINUTES)
#define DECOMPOSITION_TIME_GROSS (10 MINUTES) // bobaEDIT CHANGE, - ORIGINAL: #define DECOMPOSITION_TIME_GROSS (7 MINUTES)
