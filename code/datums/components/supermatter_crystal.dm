...
/datum/component/supermatter_crystal/proc/animal_hit(datum/source, mob/living/simple_animal/user, list/modifiers)
	...
	CONFIG_GET(flag/enable_sm_dusting) ? span_danger("[user] unwisely [murder] [atom_source], and [user.p_their()] body burns brilliantly before flashing into ash!") : span_danger("[user] unwisely [murder] [atom_source], and [user.p_their()] body burns brilliantly before the blast hurls [user.p_them()] away!"), // NOVA EDIT CHANGE - ORIGINAL: span_danger("[user] unwisely [murder] [atom_source], and [user.p_their()] body burns brilliantly before flashing into ash!"), \
	CONFIG_GET(flag/enable_sm_dusting) ? span_userdanger("You unwisely touch [atom_source], and your vision glows brightly as your body crumbles to dust. Oops.") : span_userdanger("You unwisely touch [atom_source], and your vision glows white-hot before the blast hurls you away. Oops."), // NOVA EDIT CHANGE - ORIGINAL: span_userdanger("You unwisely touch [atom_source], and your vision glows brightly as your body crumbles to dust. Oops."), \
...
/datum/component/supermatter_crystal/proc/hand_hit(datum/source, mob/living/user, list/modifiers)
	...
	dust_mob(source, user,
		CONFIG_GET(flag/enable_sm_dusting) ? span_danger("[user] leans in and tries to lick [atom_source], inducing a resonance... [user.p_their()] body starts to glow and burst into flames before flashing into dust!") : span_danger("[user] leans in and tries to lick [atom_source], inducing a resonance... [user.p_their()] body starts to glow white-hot before the blast hurls [user.p_them()] away!"), // NOVA EDIT CHANGE - ORIGINAL: span_danger("[user] leans in and tries to lick [atom_source], inducing a resonance... [user.p_their()] body starts to glow and burst into flames before flashing into dust!"),
...
/datum/component/supermatter_crystal/proc/attackby_hit(datum/source, obj/item/item, mob/living/user, params)
	...
	if(atom_source.Adjacent(user)) //if the item is stuck to the person, kill the person too instead of eating just the item.
		if(user.incorporeal_move || HAS_TRAIT(user, TRAIT_GODMODE))
			return
		var/vis_msg = CONFIG_GET(flag/enable_sm_dusting) ? span_danger("[user] reaches out and touches [atom_source] with [item], inducing a resonance... [item] starts to glow briefly before the light continues up to [user]'s body. [user.p_They()] burst[user.p_s()] into flames before flashing into dust!") : span_danger("[user] reaches out and touches [atom_source] with [item], inducing a resonance... [item] starts to glow briefly before the light continues up to [user]'s body. [user.p_They()] burst[user.p_s()] into flames and [user.p_are()] hurled away!") // NOVA EDIT CHANGE - ORIGINAL: var/vis_msg = span_danger("[user] reaches out and touches [atom_source] with [item], inducing a resonance... [item] starts to glow briefly before the light continues up to [user]'s body. [user.p_They()] burst[user.p_s()] into flames before flashing into dust!")
...
/datum/component/supermatter_crystal/proc/bumped_hit(datum/source, atom/movable/hit_object)
	...
	if(isliving(hit_object))
		hit_object.visible_message(CONFIG_GET(flag/enable_sm_dusting) ? span_danger("\The [hit_object] slams into \the [atom_source] inducing a resonance... [hit_object.p_their()] body starts to glow and burst into flames before flashing into dust!") : span_danger("\The [hit_object] slams into \the [atom_source] inducing a resonance... [hit_object.p_their()] body starts to glow white-hot before the blast hurls [hit_object.p_them()] away!"), // NOVA EDIT CHANGE - ORIGINAL: hit_object.visible_message(span_danger("\The [hit_object] slams into \the [atom_source] inducing a resonance... [hit_object.p_their()] body starts to glow and burst into flames before flashing into dust!"),
...
/datum/component/supermatter_crystal/proc/dust_mob(datum/source, mob/living/nom, vis_msg, mob_msg, cause)
	...
	var/atom/atom_source = source
	if(!vis_msg)
		vis_msg = CONFIG_GET(flag/enable_sm_dusting) ? span_danger("[nom] reaches out and touches [atom_source], inducing a resonance... [nom.p_their()] body starts to glow and burst into flames before flashing into dust!") : span_danger("[nom] reaches out and touches [atom_source], inducing a resonance... [nom.p_their()] body starts to glow white-hot before the blast hurls [nom.p_them()] away!") // NOVA EDIT CHANGE - ORIGINAL: vis_msg = span_danger("[nom] reaches out and touches [atom_source], inducing a resonance... [nom.p_their()] body starts to glow and burst into flames before flashing into dust!")
	if(!mob_msg)
		mob_msg = CONFIG_GET(flag/enable_sm_dusting) ? span_userdanger("You reach out and touch [atom_source]. Everything starts burning and all you can hear is ringing. Your last thought is \"That was not a wise decision.\"") : span_userdanger("You reach out and touch [atom_source]. Everything starts burning and all you can hear is ringing before the blast hurls you away.") // NOVA EDIT CHANGE - ORIGINAL: mob_msg = span_userdanger("You reach out and touch [atom_source]. Everything starts burning and all you can hear is ringing. Your last thought is \"That was not a wise decision.\"")
	if(!cause)
		cause = "contact"
...
/datum/component/supermatter_crystal/proc/consume(atom/source, atom/movable/consumed_object)
	...
	if(isliving(consumed_object))
		var/should_dust = CONFIG_GET(flag/enable_sm_dusting) // NOVA EDIT ADDITION
