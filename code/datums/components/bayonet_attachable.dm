...
/datum/component/bayonet_attachable
	...
	var/static/list/valid_bayonets = typecacheof(list(/obj/item/knife/combat)) - /obj/item/knife/combat/throwing // bobaEDIT CHANGE - ORIGINAL: var/static/list/valid_bayonets = typecacheof(list(/obj/item/knife/combat))
