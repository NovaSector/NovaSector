...
/datum/component/toggle_attached_clothing/Initialize(
	...
	if (down_overlay_state_suffix)
		var/overlay_state = "[initial(clothing_parent.post_init_icon_state)][down_overlay_state_suffix]"
...
/datum/component/toggle_attached_clothing/proc/toggle_deployable()
	...
	if (parent_icon_state_suffix)
		parent_gear.icon_state = "[initial(parent_gear.post_init_icon_state)][parent_icon_state_suffix]"
