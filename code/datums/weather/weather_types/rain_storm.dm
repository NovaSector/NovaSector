/datum/weather/rain_storm
	...
	weather_flags = (WEATHER_TURFS | WEATHER_MOBS | WEATHER_BAROMETER) // bobaEDIT CHANGE - ORIGINAL: weather_flags = (WEATHER_TURFS | WEATHER_MOBS | WEATHER_THUNDER | WEATHER_BAROMETER)
