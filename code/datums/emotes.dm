...
/proc/relay_visual_emote_to_ai_runechat(mob/user, msg, separation = " ", pref_to_check) // NOVA EDIT CHANGE - ORIGINAL: /proc/relay_visual_emote_to_ai_runechat(mob/user, msg)
