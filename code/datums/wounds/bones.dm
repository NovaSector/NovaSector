...
/datum/wound/blunt/bone
	...
	wound_flags = (ACCEPTS_GAUZE | SPLINT_OVERLAY) // bobaEDIT: MEDICAL -- Makes bone wounds have a splint overlay
...
/datum/wound/blunt/bone/severe
	...
	wound_flags = (ACCEPTS_GAUZE | MANGLES_INTERIOR | SPLINT_OVERLAY) // bobaEDIT - MEDICAL (SPLINT_OVERLAY)
