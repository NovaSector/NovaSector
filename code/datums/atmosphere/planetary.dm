...
/datum/atmosphere/lavaland
	...
	restricted_chance = 0	// bobaEDIT: Disables restricted gases from rolling - Original value (30)
...
/datum/atmosphere/icemoon
	...
	restricted_chance = 0	// bobaEDIT: Disables restricted gases from rolling - Original value (20)
