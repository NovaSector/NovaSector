...
/datum/element/voucher_redeemer/Attach(datum/target, voucher_type = /obj/item/coin, set_type = /datum/voucher_set, drop_direction = 0, sound_effect = 'sound/machines/machine_vend.ogg') // bobaADDITION EDIT, old code: /datum/element/voucher_redeemer/Attach(datum/target, voucher_type = /obj/item/coin, set_type = /datum/voucher_set)
	. = ..()
	if(!ismovable(target))
