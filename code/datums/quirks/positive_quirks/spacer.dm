...
/datum/quirk/spacer_born
	...
	mail_goodies = list(
		/obj/item/reagent_containers/hypospray/medipen/deforest/psifinil, // bobaEDIT CHANGE - ORIGINAL: /obj/item/storage/pill_bottle/ondansetron,
...
/datum/quirk/spacer_born/post_add()
	...
	var/obj/item/storage/medkit/civil_defense/comfort/stocked/disgust_killers = new() // bobaEDIT CHANGE - a custom deforest cheesekit filled with much better meds - ORIGINAL: var/obj/item/storage/pill_bottle/ondansetron/disgust_killers = new()
