 ...
 */
/proc/reject_bad_name(t_in, allow_numbers = TRUE, max_length = MAX_NAME_LEN, ascii_only = TRUE, strict = FALSE, cap_after_symbols = TRUE) // bobaEDIT CHANGE - allow_numbers to TRUE
	if(!t_in)
