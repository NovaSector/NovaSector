...
/datum/round_event/valentines/announce(fake)
	...
	send_ooc_announcement("It's Valentines time again! Remember that while it is 100% optional to participate, please don't send in ahelps to have the antag datum to be removed. Note: you can ignore the warning message when you need to cryo and you were affected by the Valentine's Day event, do note normal cryo rules still apply to heads of staff and non-Valentine's day antags.", "Server Announcement", sound_override = "modular_nova/modules/alerts/sound/alerts/attention.ogg")
	toggle_aooc(0)
