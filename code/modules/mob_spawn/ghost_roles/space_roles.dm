...
/obj/effect/mob_spawn/ghost_role/human/oldstation/create_from_ghost(mob/dead/user, use_loadout = FALSE) // NOVA EDIT CHANGE - ORIGINAL: /obj/effect/mob_spawn/ghost_role/human/oldstation/create_from_ghost(mob/dead/user)
	. = ..()
	notify_ghosts(
