...
/obj/item/bodypart/arm/left/golem
	...
	should_draw_greyscale = FALSE
	dmg_overlay_type = null
	bodypart_traits = list(TRAIT_CHUNKYFINGERS, TRAIT_FIST_MINING, TRAIT_BOULDER_BREAKER) // NOVA EDIT CHANGE - ORIGINAL: bodypart_traits = list(TRAIT_CHUNKYFINGERS, TRAIT_FIST_MINING)
