...
/obj/item/organ/tail
	...
	//dna_block = DNA_TAIL_BLOCK // bobaEDIT REMOVAL - Customization - We have our own system to handle DNA.
...
/obj/item/organ/tail/proc/try_insert_tail_spines(obj/item/bodypart/bodypart)
	...
	var/feature_name = bodypart.owner.dna.mutant_bodyparts["spines"][MUTANT_INDEX_NAME] // bobaEDIT CHANGE - ORIGINAL: var/feature_name = bodypart.owner.dna.features["spines"] //tail spines don't live in DNA, but share feature names with regular spines
	tail_spines_overlay.set_appearance_from_dna(bodypart.owner.dna, feature_name, feature_key = "spines") // bobaEDIT CHANGE - ORIGINAL: tail_spines_overlay.set_appearance_from_name(feature_name)
...
/datum/bodypart_overlay/mutant/tail/cat
	feature_key = "tail" // bobaEDIT - Customization - ORIGINAL: feature_key = "tail_cat"
	// color_source = ORGAN_COLOR_HAIR // bobaEDIT REMOVAL

/datum/bodypart_overlay/mutant/tail/cat/get_global_feature_list()
	return SSaccessories.sprite_accessories["tail"] // bobaEDIT CHANGE - ORIGINAL: return SSaccessories.tails_list_felinid
...
/datum/bodypart_overlay/mutant/tail/monkey
	color_source = NONE
	feature_key = "tail" // bobaEDIT - Customization - ORIGINAL: feature_key = "tail_monkey"
...
/obj/item/organ/tail/lizard
	...
	wag_flags = WAG_ABLE
	//dna_block = DNA_LIZARD_TAIL_BLOCK // bobaEDIT REMOVAL - Customization - We have our own system to handle DNA.

///Lizard tail bodypart overlay datum
/datum/bodypart_overlay/mutant/tail/lizard
	feature_key = "tail" // bobaEDIT - Customization - ORIGINAL: feature_key = "tail_lizard"

/datum/bodypart_overlay/mutant/tail/lizard/get_global_feature_list()
	return SSaccessories.sprite_accessories["tail"] // bobaEDIT - Customization - ORIGINAL: return SSaccessories.tails_list_lizard
...
/datum/bodypart_overlay/mutant/tail_spines/get_global_feature_list()
	return SSaccessories.sprite_accessories["tailspines"] // bobaEDIT CHANGE - ORIGINAL: return SSaccessories.tail_spines_list
