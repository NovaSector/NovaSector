...
/datum/bodypart_overlay/mutant/tail/get_global_feature_list()
	return GLOB.sprite_accessories["tail"] // NOVA EDIT CHANGE - ORIGINAL: return SSaccessories.tails_list_human
...
/datum/bodypart_overlay/mutant/tail/lizard/get_global_feature_list()
	return GLOB.sprite_accessories["tail"] // NOVA EDIT - Customization - ORIGINAL: return SSaccessories.tails_list_lizard
...
/datum/bodypart_overlay/mutant/tail_spines/get_global_feature_list()
	return GLOB.sprite_accessories["tailspines"] // NOVA EDIT CHANGE - ORIGINAL: return SSaccessories.tail_spines_list
