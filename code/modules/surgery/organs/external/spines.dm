...
/obj/item/organ/spines
	...
	//dna_block = DNA_SPINES_BLOCK // bobaEDIT REMOVAL - Customization - We have our own system to handle DNA.
...
/datum/bodypart_overlay/mutant/spines/get_global_feature_list()
	return SSaccessories.sprite_accessories["spines"] // bobaEDIT - Customization - ORIGINAL: return SSaccessories.spines_list
