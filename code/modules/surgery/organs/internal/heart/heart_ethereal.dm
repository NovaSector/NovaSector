...
/obj/structure/ethereal_crystal/proc/heal_ethereal()
	...
	regenerating.apply_status_effect(/datum/status_effect/vulnerable_to_damage) // bobaEDIT ADDITION - This lasts for five minutes, the full duration of the cooldown.
