...
/datum/surgery_step/manipulate_organs/internal/can_use_organ(obj/item/organ/organ)
	return !(organ.organ_flags & ORGAN_EXTERNAL) && !(organ.organ_flags & ORGAN_UNREMOVABLE) // bobaEDIT - Don't show unremovable organs - ORIGINAL: return !(organ.organ_flags & ORGAN_EXTERNAL)
