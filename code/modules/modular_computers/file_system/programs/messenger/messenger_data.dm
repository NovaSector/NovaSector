...
/datum/pda_message/New(message, outgoing, timestamp, photo_name = null, everyone = FALSE, subtle) // bobaADDITION - ORIGINAL: /datum/pda_message/New(message, outgoing, timestamp, photo_name = null, everyone = FALSE)
	src.message = message
	src.outgoing = outgoing
	src.timestamp = timestamp
	src.photo_name = photo_name
	src.everyone = everyone
	src.subtle = subtle // bobaEDIT ADDITION
...
/datum/pda_message/proc/get_ui_data(mob/user)
	...
	data["subtle"] = subtle // bobaEDIT ADDITION
	return data
