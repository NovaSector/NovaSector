...
/obj/item/crusher_trophy/retool_kit/add_to(obj/item/kinetic_crusher/pkc, mob/user)
	...
	if(active_skin.retool_worn_file) // NOVA EDIT ADDITION
		pkc.worn_icon = active_skin.retool_worn_file // NOVA EDIT ADDITION
		pkc.worn_icon_state = active_skin::retool_icon_state // NOVA EDIT ADDITION
...
/obj/item/crusher_trophy/retool_kit/remove_from(obj/item/kinetic_crusher/pkc)
	...
	pkc.worn_icon = initial(pkc.worn_icon) // NOVA EDIT ADDITION
	pkc.worn_icon_state = initial(pkc.worn_icon_state) // NOVA EDIT ADDITION
...
/datum/crusher_skin
	...
	var/retool_icon = 'icons/obj/mining.dmi' // NOVA EDIT CHANGE - ORIGINAL: var/retool_icon = null
	...
	/// Specifies the worn icon file. // NOVA EDIT ADDITION
	var/retool_worn_file = null // NOVA EDIT ADDITION
