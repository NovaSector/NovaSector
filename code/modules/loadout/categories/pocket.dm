...
/datum/loadout_item/pocket_items/lipstick/handle_loadout_action(datum/preference_middleware/loadout/manager, mob/user, action, params)
	switch(action)
		if("select_lipstick_style")
			var/list/their_loadout = manager.get_current_loadout() // NOVA EDIT: Multiple loadout presets: ORIGINAL: var/list/their_loadout = manager.preferences.read_preference(/datum/preference/loadout)
			...
			their_loadout =  manager.get_current_loadout() // NOVA EDIT: Multiple loadout presets: ORIGINAL: their_loadout = manager.preferences.read_preference(/datum/preference/loadout) // after sleep: sanity check
		...
		if("select_lipstick_color")
			var/list/their_loadout = manager.get_current_loadout() // NOVA EDIT: Multiple loadout presets: ORIGINAL: var/list/their_loadout = manager.preferences.read_preference(/datum/preference/loadout) // after sleep: sanity check
