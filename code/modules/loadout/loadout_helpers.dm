...
/mob/living/carbon/human/proc/equip_outfit_and_loadout(
	...
	var/list/loadout_datums = client.get_loadout_datums() // NOVA EDIT CHANGE: Multiple loadout presets - Original: var/list/loadout_datums = loadout_list_to_datums(preference_list)
