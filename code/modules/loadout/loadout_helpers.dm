...
/mob/living/carbon/human/proc/equip_outfit_and_loadout(
	...
	var/list/loadout_datums = loadout_list_to_datums(preference_list[preference_source.read_preference(/datum/preference/loadout_index)]) // bobaEDIT CHANGE - Multiple loadout presets - ORIGINAL: var/list/loadout_datums = loadout_list_to_datums(preference_list)
