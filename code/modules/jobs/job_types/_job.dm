...
/mob/living/proc/on_job_equipping(datum/job/equipping, datum/preferences/used_pref, client/player_client) // NOVA EDIT CHANGE - ORIGINAL: /mob/living/proc/on_job_equipping(datum/job/equipping)
	return
...
/mob/living/carbon/human/on_job_equipping(datum/job/equipping, datum/preferences/used_pref, client/player_client) //NOVA EDIT CHANGE - ORIGINAL: /mob/living/carbon/human/on_job_equipping(datum/job/equipping)
	...
	//dress_up_as_job(equipping, FALSE, used_pref) // ORIGINAL: dress_up_as_job(equipping), MOVED TO /living/on_job_equipping
	. = ..()
...
/mob/living/proc/dress_up_as_job(datum/job/equipping, visual_only = FALSE, datum/preferences/used_pref) //NOVA EDIT CHANGE
	return
...
/mob/living/carbon/human/dress_up_as_job(datum/job/equipping, visual_only = FALSE, datum/preferences/used_pref) //NOVA EDIT CHANGE
	...
	// NOVA EDIT CHANGE BEGIN
	//equip_outfit_and_loadout(equipping.outfit, used_pref, visual_only, equipping) // NOVA EDIT CHANGE - MOVED TO /mob/living/dress_up_as_job
	return ..()
	// NOVA EDIT CHANGE END
