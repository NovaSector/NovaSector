...
/obj/projectile/hook
	...
	var/chain_icon = 'icons/effects/beam.dmi' // bobaEDIT ADDITION

/obj/projectile/hook/fire(setAngle)
	if(firer)
		initial_chain = firer.Beam(src, icon_state = "chain", icon = chain_icon, emissive = FALSE) // bobaEDIT CHANGE - Adds icon arg - ORIGINAL: chain = firer.Beam(src, icon_state = "chain", emissive = FALSE)
