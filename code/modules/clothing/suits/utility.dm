...
/obj/item/clothing/suit/utility/fire
	...
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT|HIDETAIL|HIDETAUR // bobaEDIT ADDITION - HIDETAIL, HIDETAUR
...
/obj/item/clothing/suit/utility/fire/atmos
	...
	cold_protection = CHEST|GROIN|LEGS|FEET|ARMS
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	flags_inv = HIDESHOES|HIDEJUMPSUIT|HIDETAUR|HIDETAIL // bobaEDIT ADDITION - HIDETAUR, HIDETAIL
...
/obj/item/clothing/suit/utility/bomb_suit
	...
	flags_inv = HIDEJUMPSUIT|HIDETAIL|HIDETAUR // bobaEDIT ADDITION - HIDETAIL, HIDETAUR
	heat_protection = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
...
/obj/item/clothing/suit/utility/radiation
	...
	strip_delay = 60
	equip_delay_other = 60
	flags_inv = HIDEJUMPSUIT|HIDETAIL // bobaEDIT ADDITION - HIDETAIL
	resistance_flags = NONE
