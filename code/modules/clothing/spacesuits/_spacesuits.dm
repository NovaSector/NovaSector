...
/obj/item/clothing/suit/space
	...
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT|HIDESEXTOY|HIDETAIL|HIDETAUR|HIDEFOURARMS //NOVA EDIT CHANGE - ADDED HIDEFOURARMS, HIDETAIL, HIDETAUR. ADDED HIDESEXTOY TO PREVENT VISUAL BUGS.
