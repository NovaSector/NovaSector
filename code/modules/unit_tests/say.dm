...
/datum/unit_test/speech/proc/conversation(distance = 0)
	...
	var/pangram_quote = "The quick brown fox jumps over the lazy dog." // bobaEDIT CHANGE - account for autopunct in living_say.dm - ORIGINAL: var/pangram_quote = "The quick brown fox jumps over the lazy dog"
