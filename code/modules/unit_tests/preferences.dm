...
/datum/unit_test/preferences_implement_everything/Run()
	...
	for (var/preference_type in GLOB.preference_entries)
		...
		if (preference.savefile_identifier == PREFERENCE_CHARACTER)
			preference.apply_to_human(human, preference.create_informed_default_value(preferences), preferences) // bobaEDIT CHANGE - ORIGINAL: preference.apply_to_human(human, preference.create_informed_default_value(preferences))
