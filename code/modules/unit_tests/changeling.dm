...
/datum/unit_test/transformation_sting/proc/setup_ling()
	...
	ling.dna.mutant_bodyparts[FEATURE_TAIL_LIZARD] = list(MUTANT_INDEX_NAME = "Smooth", MUTANT_INDEX_COLOR_LIST = list("#886600", "#886600", "#886600")) // NOVA EDIT CHANGE - ORIGINAL: ling.dna.features[FEATURE_TAIL_LIZARD] = "Smooth"
