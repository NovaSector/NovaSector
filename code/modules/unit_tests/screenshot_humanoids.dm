...
/datum/unit_test/screenshot_humanoids/Run()
	...
	lizard.dna.mutant_bodyparts["tail"] = list(MUTANT_INDEX_NAME = "Light Tiger", MUTANT_INDEX_COLOR_LIST = list("#009999", "#009999", "#009999")) // bobaEDIT - Customization - ORIGINAL: lizard.dna.features["tail_lizard"] = "Light Tiger"
	lizard.dna.mutant_bodyparts["snout"] = list(MUTANT_INDEX_NAME = "Sharp + Light", MUTANT_INDEX_COLOR_LIST = list("#009999", "#009999", "#009999")) // bobaEDIT - Customization - ORIGINAL: lizard.dna.features["snout"] = "Sharp + Light"
	lizard.dna.mutant_bodyparts["horns"] = list(MUTANT_INDEX_NAME = "Simple", MUTANT_INDEX_COLOR_LIST = list("#009999", "#009999", "#009999")) // bobaEDIT - Customization - ORIGINAL: lizard.dna.features["horns"] = "Simple"
	lizard.dna.mutant_bodyparts["frills"] = list(MUTANT_INDEX_NAME = "Aquatic", MUTANT_INDEX_COLOR_LIST = list("#009999", "#009999", "#009999")) // bobaEDIT - Customization - ORIGINAL: lizard.dna.features["frills"] = "Aquatic"
	...
	moth.dna.features["mcolor"] = "#E5CD99" // bobaEDIT ADDITION - Customization
	moth.dna.mutant_bodyparts["moth_antennae"] = list(MUTANT_INDEX_NAME = "Firewatch", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: moth.dna.features["moth_antennae"] = "Firewatch"
	moth.dna.mutant_bodyparts["moth_markings"] = list(MUTANT_INDEX_NAME = "None", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: moth.dna.features["moth_markings"] = "None"
	moth.dna.mutant_bodyparts["wings"] = list(MUTANT_INDEX_NAME = "Moth (Firewatch)", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: moth.dna.features["moth_wings"] = "Firewatch"
...
/datum/unit_test/screenshot_humanoids/proc/make_dummy(species, job_outfit)
	...
	// bobaEDIT ADDITION START - More consistent screenshots
