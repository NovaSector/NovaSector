...
/datum/unit_test/defined_inhand_icon_states
	...
	/// additional_inhands_location is for downstream modularity support. as an example, for nova's usage, set additional_inhands_location = "modular_nova/master_files/icons/mob/inhands/"
