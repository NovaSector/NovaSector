...
/obj/item/ph_meter/interact_with_atom(atom/interacting_with, mob/living/user, list/modifiers)
	...
	for(var/datum/reagent/reagent in cont.reagents.reagent_list)
		...
		if(reagent.purity < reagent.inverse_chem_val && reagent.inverse_chem)
			...
			out_message += "<b>[round(reagent.volume, 0.01)]u of [reagent.name][blood_info]</b>, <b>Purity:</b> [round(reagent.purity, 0.000001)*100]%, [(scanmode?"[(reagent.overdose_threshold?"<b>Overdose:</b> [reagent.overdose_threshold]u, ":"")]<b>Base pH:</b> [initial(reagent.ph)], <b>Current pH:</b> [reagent.ph].":"<b>Current pH:</b> [reagent.ph].")]\n"
		if(scanmode)
