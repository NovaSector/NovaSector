...
/obj/machinery/chem_dispenser/drinks/Initialize(mapload)
	if(type == /obj/machinery/chem_dispenser/drinks || /obj/machinery/chem_dispenser/drinks/fullupgrade || upgrade_reagents != null && !upgrade_reagents.len) //NOVA EDIT CHANGE - if(dispensable_reagents != null && !dispensable_reagents.len)
