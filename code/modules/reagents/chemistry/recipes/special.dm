...
/obj/item/paper/secretrecipe/proc/UpdateInfo()
	...
	var/datum/chemical_reaction/recipe = GLOB.chemical_reactions_list[/datum/chemical_reaction/randomized/sansufentanyl] // NOVA EDIT CHANGE - ORIGINAL: var/datum/chemical_reaction/recipe = GLOB.chemical_reactions_list[pick(valid_subtypesof(/datum/chemical_reaction/randomized))]
	if(!recipe)
