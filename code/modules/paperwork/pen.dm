...
/obj/item/pen/edagger/on_transform(obj/item/source, mob/user, active)
	if(active)
		...
		lefthand_file = lefthand_icon // NOVA EDIT, old code: lefthand_file = 'icons/mob/inhands/weapons/swords_lefthand.dmi'
		righthand_file = righthand_icon // NOVA EDIT, old code: righthand_file = 'icons/mob/inhands/weapons/swords_righthand.dmi'
