...
/mob/living/verb/succumb(whispered as num|null)
	...
	message_admins("[key_name_admin(usr)] Has [whispered ? "whispered his final words" : "succumbed to death"] with [round(health, 0.1)] points of health!") // NOVA EDIT CHANGE ADDITION
