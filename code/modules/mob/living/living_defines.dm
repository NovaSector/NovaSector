/mob/living
	...
	hud_possible = list(HEALTH_HUD,STATUS_HUD,ANTAG_HUD,DNR_HUD,NANITE_HUD,DIAG_NANITE_FULL_HUD) // NOVA EDIT ADDITION - DNR_HUD / NANITE_HUD) // NOVA EDIT ADDITION - ORIGINAL hud_possible = list(HEALTH_HUD,STATUS_HUD,ANTAG_HUD)
