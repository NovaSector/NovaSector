...
/mob/living/carbon/human/proc/randomize_human_appearance(randomize_flags = ALL)
	...
	for (var/datum/preference/preference as anything in get_preferences_in_priority_order())
		...
		if (preference.is_randomizable())
			preference.apply_to_human(src, preference.create_random_value(preferences)) // NOVA EDIT CHANGE - ORIGINAL: preference.apply_to_human(src, preference.create_random_value(preferences), preferences)
