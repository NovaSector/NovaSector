...
/atom/movable/screen/buildmode/mode/update_icon_state()
	icon = bd.mode.button_icon // bobaEDIT ADDITION - remove buildmode duplicate icons, divine tg and skyrat
...
/atom/movable/screen/buildmode/modeswitch/New(bld, mt)
	modetype = mt
	icon = initial(modetype.button_icon)// bobaEDIT ADDITION - remove buildmode duplicate icons, divine tg and skyrat
