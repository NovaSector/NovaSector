...
/datum/preference/color/ooc_color/is_accessible(datum/preferences/preferences)
	...
	return is_admin(preferences.parent) || preferences.unlock_content || SSplayer_ranks.is_donator(preferences.parent) // bobaEDIT CHANGE - ORIGINAL: return is_admin(preferences.parent) || preferences.unlock_content
