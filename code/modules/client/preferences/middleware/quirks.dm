...
/datum/preference_middleware/quirks/get_constant_data()
	...
	for (var/quirk_name in quirks)
		...
		quirk_info[sanitize_css_class_name(quirk_name)] = list(
			...
			"nova_stars_only" = initial(quirk.nova_stars_only), // bobaEDIT ADDITION - Veteran quirks
			"erp_quirk" = initial(quirk.erp_quirk), // bobaEDIT ADDITION - Purple ERP quirks
		)
...
/datum/preference_middleware/quirks/proc/give_quirk(list/params, mob/user)
	...
	if (SSquirks.filter_invalid_quirks(new_quirks, preferences.augments) != new_quirks)// bobaEDIT - AUGMENTS+
...
/datum/preference_middleware/quirks/proc/remove_quirk(list/params, mob/user)
	...
	var/list/new_quirks = preferences.all_quirks - quirk_name
	if (!(quirk_name in preferences.all_quirks) || SSquirks.filter_invalid_quirks(new_quirks, preferences.augments) != new_quirks)// bobaEDIT - AUGMENTS+
