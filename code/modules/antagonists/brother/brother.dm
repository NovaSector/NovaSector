...
/datum/antagonist/brother/get_preview_icon()
	...
	brother2.dna.features["mcolor"] = "#E5CD99" // bobaEDIT ADDITION - Customization
	brother2.dna.mutant_bodyparts["moth_antennae"] = list(MUTANT_INDEX_NAME = "Plain", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: brother2.dna.features["moth_antennae"] = "Plain"
	brother2.dna.mutant_bodyparts["moth_markings"] = list(MUTANT_INDEX_NAME = "None", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: brother2.dna.features["moth_markings"] = "None"
	brother2.dna.mutant_bodyparts["wings"] = list(MUTANT_INDEX_NAME = "Moth (Plain)", MUTANT_INDEX_COLOR_LIST = list("#FFFFFF", "#FFFFFF", "#FFFFFF")) // bobaEDIT - Customization - ORIGINAL: brother2.dna.features["moth_wings"] = "Plain"
