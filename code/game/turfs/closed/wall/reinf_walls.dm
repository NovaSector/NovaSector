...
/turf/closed/wall/r_wall/update_icon_state()
	if(d_state != INTACT)
		icon = 'modular_nova/modules/aesthetics/walls/icons/reinforced_wall.dmi' // bobaEDIT CHANGE - AESTHETICS - ORIGINAL: icon = 'icons/turf/walls/reinforced_states.dmi'
		icon_state = "[base_decon_state]-[d_state]"
	else
		icon = 'modular_nova/modules/aesthetics/walls/icons/reinforced_wall.dmi' // bobaEDIT CHANGE - AESTHETICS -  ORIGINAL: icon = 'icons/turf/walls/reinforced_wall.dmi'
