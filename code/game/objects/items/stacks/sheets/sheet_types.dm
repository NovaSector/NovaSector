...
GLOBAL_LIST_INIT(plasteel_recipes, list ( \
	...
	new/datum/stack_recipe("scrap beacon", /obj/structure/shell_scrap_beacon, 10, time = 10 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF, category = CAT_MISC),
