...
/obj/item/storage/belt/utility/chief/full/PopulateContents()
	return list(
		...
		SSwardrobe.provide_type(/obj/item/analyzer/ranged, src), //NOVA EDIT CHANGE - Ranged Analyzer for CE - ORIGINAL: SSwardrobe.provide_type(/obj/item/analyzer, src),
	)
...
/obj/item/storage/belt/utility/full/powertools/PopulateContents()
	return list(
		...
		/obj/item/weldingtool/electric, // NOVA EDIT CHANGE - original: /obj/item/weldingtool/experimental
		/obj/item/multitool,
