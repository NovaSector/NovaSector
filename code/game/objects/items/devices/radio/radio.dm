	...
	if(isliving(talking_movable))
		...
		*/
		if(radio_noise && COOLDOWN_FINISHED(src, audio_cooldown))
			...
			playsound_if_pref(src, radio_talk_sound, radio_sound_volume, TRUE, radio_sound_range, SOUND_FALLOFF_EXPONENT, pref_to_check = /datum/preference/toggle/radio_noise) // NOVA EDIT ADDITION
