...
/obj/item/vape
	...
	worn_icon_muzzled = 'modular_nova/master_files/icons/mob/clothing/mask.dmi' //NOVA EDIT ADDITION - Mutant Greyscale
	icon_state = "vape"
	...
	greyscale_config_worn_muzzled = /datum/greyscale_config/vape/worn/muzzled //NOVA EDIT ADDITION - Mutant Greyscale
