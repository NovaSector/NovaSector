...
/obj/structure/flora/tree/harvest(mob/living/user, product_amount_multiplier)
	...
	var/obj/structure/flora/tree/stump/new_stump = new stump_type(my_turf) // bobaEDIT CHANGE - Variable tree stumps - ORIGINAL: var/obj/structure/flora/tree/stump/new_stump = new(my_turf)
