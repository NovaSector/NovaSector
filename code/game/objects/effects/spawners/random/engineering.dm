...
/obj/effect/spawner/random/engineering/material_rare
	...
	loot = list( // Space loot spawner. Random selecton of a few rarer materials.
		//obj/item/stack/sheet/runed_metal/ten = 20,  // bobaEDIT REMOVAL - No more Runed Metal
		...
		//obj/item/stack/sheet/runed_metal/fifty = 5, // bobaEDIT REMOVAL - No more Runed Metal
	)
