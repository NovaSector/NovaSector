...
/obj/machinery/door/airlock
	...
	var/overlays_file = 'icons/obj/doors/airlocks/tall/overlays.dmi' //OVERRIDDEN IN NOVA AESTHETICS - SEE MODULE
	/// Used for papers and photos pinned to the airlock
	var/note_overlay_file = 'icons/obj/doors/airlocks/tall/overlays.dmi' //OVERRIDDEN IN NOVA AESTHETICS - SEE MODULE
