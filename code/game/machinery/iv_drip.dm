...
#define MAX_IV_TRANSFER_RATE 15 // NOVA EDIT CHANGE - Original: 5 - Made to triple the max rate of the IV transfer to avoid having players to need to use 3 IV drips.
