...
#define MAX_IV_TRANSFER_RATE 15 // bobaEDIT CHANGE - Made to triple the max rate of the IV transfer to avoid having players to need to use 3 IV drips. - Original: MAX_IV_TRANSFER_RATE 5
