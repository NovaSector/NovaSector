...
//	var/safe_water_level = parent_type::safe_oxygen_min // NOVA EDIT, moved to parent type
...
/obj/item/organ/lungs/proc/breathe_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp, old_water_pp) // NOVA EDIT, (yes this is ugly) - old code: /obj/item/organ/lungs/fish/proc/breathe_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp, old_water_pp)
...
/obj/item/organ/lungs/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp) // NOVA EDIT, (maybe upstream this?) - old code: /obj/item/organ/lungs/fish/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp)
