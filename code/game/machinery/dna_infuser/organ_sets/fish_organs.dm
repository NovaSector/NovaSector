...
/obj/item/organ/lungs/fish
	...
	//var/safe_water_level = parent_type::safe_oxygen_min // bobaEDIT REMOVAL - moved to parent type
...
/obj/item/organ/lungs/proc/breathe_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp, old_water_pp) // bobaEDIT CHANGE, ORIGINAL: /obj/item/organ/lungs/fish/proc/breathe_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp, old_water_pp)
...
/obj/item/organ/lungs/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp) // bobaEDIT CHANGE - (maybe upstream this?) - ORIGINAL: /obj/item/organ/lungs/fish/proc/on_low_water(mob/living/carbon/breather, datum/gas_mixture/breath, water_pp)
