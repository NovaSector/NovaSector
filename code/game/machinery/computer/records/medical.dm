...
/obj/machinery/computer/records/medical/ui_data(mob/user)
	...
	for(var/datum/record/crew/target in GLOB.manifest.general)
		...
		records += list(list(
			age = target.age,
			chrono_age = target.chrono_age, // bobaEDIT ADDITION - Chronological age
			...
			trim = target.trim,
			// bobaEDIT ADDITION START - Expanded records!
...
/obj/machinery/computer/records/medical/ui_static_data(mob/user)
	...
	data["max_chrono_age"] = AGE_CHRONO_MAX // bobaEDIT ADDITION - Chronological age
...
/obj/machinery/computer/records/medical/expunge_record_info(datum/record/crew/target)
	...
	target.age = 18
	target.chrono_age = 18 // bobaEDIT ADDITION - Chronological age
