...
#define OPT_IN_YES_ANTAG 1
/// Fine with being round removed.
#define OPT_IN_YES_ROUND_REMOVE 2

#define OPT_IN_YES_ANTAG_STRING "Yes"
...
GLOBAL_LIST_INIT(antag_opt_in_strings, list(
	...
	"1" = OPT_IN_YES_ANTAG_STRING,
	"2" = OPT_IN_YES_ROUND_REMOVE_STRING,
))

/// Assoc list of stringified opt_in_## define to the color associated with it.
GLOBAL_LIST_INIT(antag_opt_in_colors, list(
	OPT_IN_NOT_TARGET_STRING = COLOR_GREEN,
	OPT_IN_YES_ANTAG_STRING = COLOR_ORANGE,
...
#define SECURITY_OPT_IN_LEVEL OPT_IN_YES_ANTAG
/// The minimum opt-in level for people playing command.
#define COMMAND_OPT_IN_LEVEL OPT_IN_YES_ANTAG
...
#define OPT_IN_ANTAG_ENABLED_LEVEL OPT_IN_YES_ANTAG
