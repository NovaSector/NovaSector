...
#define COMPANY_ZCM "It has a stamped in <b>[span_grey("matte white rectangle")]</b> with <b>[span_grey("Zvirdnyan Colonial Militia")]</b> readable under an angle." //-nyan :3
