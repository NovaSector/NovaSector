...
#define COMPANY_BAIKAL "It has a small <b>[span_red("A pentagon with an arrow inside it")]</b> alongside <b>[span_red("Baikal Heavy Industry Concern")]</b> etched into it."
