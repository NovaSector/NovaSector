...
#define MINER_POINT_MULTIPLIER 150 // bobaEDIT: ORIGINAL #define MINER_POINT_MULTIPLIER 100
/// The multiplier that gets applied for automatically generated mining points.
#define MINING_POINT_MACHINE_MULTIPLIER 0.6 // bobaEDIT: ORIGINAL #define MINING_POINT_MACHINE_MULTIPLIER 0.8 - To scale point generation for a longer round
