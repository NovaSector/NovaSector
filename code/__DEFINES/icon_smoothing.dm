...
#define MAX_S_TURF 91 //Always match this value with the one above it. // NOVA EDIT CHANGE - ORIGINAL: #define MAX_S_TURF 67 //Always match this value with the one above it.
