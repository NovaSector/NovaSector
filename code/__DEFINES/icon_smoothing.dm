...
#define MAX_S_TURF 65 //Always match this value with the one above it. // NOVA EDIT CHANGE - ORIGINAL: MAX_S_TURF 61
...
//NOVA EDIT ADDITION START
#define SMOOTH_GROUP_SHIPWALLS S_OBJ(81)	///turf/closed/wall/mineral/titanium/spaceship
#define SMOOTH_GROUP_STONE_WALLS S_OBJ(82) ///turf/closed/wall/mineral/stone, /obj/structure/falsewall/stone

#define SMOOTH_GROUP_SHUTTERS S_OBJ(83)

#define SMOOTH_GROUP_WATER S_OBJ(84) ///obj/effect/abstract/liquid_turf
//NOVA EDIT ADDITION END
