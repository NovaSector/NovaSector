...
#define CALIBER_45 ".460 Ceres" // NOVA EDIT - was .45, we run .460 Ceres
/// The caliber used by sniper rifles.
#define CALIBER_50BMG ".416 Stabilis" // NOVA EDIT - was .50BMG
/// The caliber used by the desert eagle.
#define CALIBER_50AE ".454 Trucidator" // NOVA EDIT - was .50AE
