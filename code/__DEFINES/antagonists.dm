...
#define TELECRYSTALS_DEFAULT 35 // bobaEDIT CHANGE - ORIGINAL: #define TELECRYSTALS_DEFAULT 20
/// How many telecrystals mapper/admin only "precharged" uplink implant
#define TELECRYSTALS_PRELOADED_IMPLANT 20 // bobaEDIT CHANGE - ORIGINAL: #define TELECRYSTALS_PRELOADED_IMPLANT 10
