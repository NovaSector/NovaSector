...
#define MAX_CORES_GRAVITATIONAL 8 // NOVA EDIT CHANGE - ORIGINAL: #define MAX_CORES_GRAVITATIONAL 6 - Same reasons as the Bluespace cores above,
#define MAX_CORES_FLUX 8 // NOVA EDIT CHANGE - ORIGINAL: #define MAX_CORES_FLUX 5 - Same as prior too.
