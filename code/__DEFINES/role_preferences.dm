...
#define ROLE_SPACE_SYNDICATE "Syndicate Space Personnel" // NOVA EDIT - Original: "Space Syndicate"
#define ROLE_SYNDICATE_CYBERSUN "Syndicate Cybersun Crew" //Ghost role syndi from Forgottenship ruin // NOVA EDIT - Original: "Cybersun Space Syndicate"
#define ROLE_SYNDICATE_CYBERSUN_CAPTAIN "Syndicate Cybersun Captain" //Forgottenship captain syndie // NOVA EDIT - Original: "Cybersun Space Syndicate Captain"
