...
#define isashwalker(A) (is_species(A, /datum/species/lizard/ashwalker) || is_species(A, /datum/species/human/ashwalker)) // NOVA EDIT CHANGE - ORIGINAL: #define isashwalker(A) (is_species(A, /datum/species/lizard/ashwalker))
