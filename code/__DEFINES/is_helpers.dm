...
//Human sub-species
#define isabductor(A) (is_species(A, /datum/species/abductor) && !is_species(A, /datum/species/rogue)) // NOVA EDIT CHANGE - ORIGINAL: #define isabductor(A) (is_species(A, /datum/species/abductor))
