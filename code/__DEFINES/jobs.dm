...
#define JOB_DISPLAY_ORDER_SECURITY_MEDIC 39 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_CORRECTIONS_OFFICER 40 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_NANOTRASEN_CONSULTANT 41 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_BLUESHIELD 42 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_ORDERLY 43 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_SCIENCE_GUARD 44 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_BOUNCER 45 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_ENGINEER_GUARD 46 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_CUSTOMS_AGENT 47 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_EXP_CORPS 48 //NOVA EDIT ADDITON
