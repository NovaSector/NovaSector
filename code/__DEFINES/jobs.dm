...
#define JOB_DISPLAY_ORDER_SECURITY_MEDIC 40 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_CORRECTIONS_OFFICER 41 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_NANOTRASEN_CONSULTANT 42 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_BLUESHIELD 43 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_ORDERLY 44 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_SCIENCE_GUARD 45 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_BOUNCER 46 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_ENGINEER_GUARD 47 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_CUSTOMS_AGENT 48 //NOVA EDIT ADDITION
