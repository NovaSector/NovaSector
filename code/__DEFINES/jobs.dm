...
#define JOB_DISPLAY_ORDER_VIROLOGIST 40 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_SECURITY_MEDIC 41 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_CORRECTIONS_OFFICER 42 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_NANOTRASEN_CONSULTANT 43 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_BLUESHIELD 44 //NOVA EDIT ADDITON
#define JOB_DISPLAY_ORDER_ORDERLY 45 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_SCIENCE_GUARD 46 //NOVA EDIT ADDITION
#define JOB_DISPLAY_ORDER_BOUNCER 47 //NOVA EDIT ADDITION
