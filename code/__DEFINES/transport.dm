...
#define XING_THRESHOLD_AMBER 60 // bobaEDIT CHANGE - RUN/WALK SPEED | Original: #define XING_THRESHOLD_AMBER 45
#define XING_THRESHOLD_RED 37 // bobaEDIT CHANGE - RUN/WALK SPEED | Original: 27
