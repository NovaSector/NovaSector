...
#define WIDESCREEN_VIEWPORT_SIZE "21x15" // bobaEDIT CHANGE - ORIGINAL: #define WIDESCREEN_VIEWPORT_SIZE "19x15"
...
//Ghosts
#define ui_ghost_soulcatcher "SOUTH:6, CENTER-4:24" // bobaEDIT ADDITION - Soulcatcher button
