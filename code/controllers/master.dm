...
/datum/controller/master/Initialize(delay, init_sss, tgs_prime)
	...
	// to_chat(world, span_boldannounce("Initializing subsystems..."), MESSAGE_TYPE_DEBUG) // bobaEDIT REMOVAL
	add_startup_message("Initializing subsystems...") // bobaEDIT CHANGE - Custom HTML Lobby Screen
...
/datum/controller/master/proc/init_subsystem(datum/controller/subsystem/subsystem)
	...
	// bobaEDIT REMOVAL BEGIN -- chat_message not used anymore due to change below
	// var/chat_message = chat_warning ? span_boldwarning(message) : span_boldannounce(message)
	// bobaEDIT REMOVAL END

	if(result != SS_INIT_NO_MESSAGE)
		// to_chat(world, chat_message, MESSAGE_TYPE_DEBUG) // bobaEDIT REMOVAL
		add_startup_message(message, chat_warning) // bobaEDIT ADDITION
	log_world(message)
