...
/datum/controller/subsystem/dbcore/Shutdown()
	...
	if(SSdbcore.Connect())
		...
		// bobaEDIT ADDITION START - SQL-based logging
...
/datum/controller/subsystem/dbcore/proc/InitializeRound()
	...
	var/datum/db_query/query_round_initialize = SSdbcore.NewQuery(/* NOVA EDIT CHANGE - MULTISERVER */
		...
		list("server_name" = CONFIG_GET(string/serversqlname), "internet_address" = world.internet_address || "0", "port" = "[world.port]") // bobaEDIT CHANGE - MULTISERVER
	)
