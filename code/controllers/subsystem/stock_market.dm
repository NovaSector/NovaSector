#define MINIMUM_VALUE_MULT 0.95 // bobaEDIT: used in price_minimum declarations, /tg/ default is 0.5
#define MAXIMUM_VALUE_MULT 1.05 // bobaEDIT: used in prixe_maximum declarations, /tg/ default is 3
...
/datum/controller/subsystem/stock_market/proc/adjust_material_price(datum/material/mat, delta)
	...
	//get the limits
	var/price_minimum = round(mat.value_per_unit * SHEET_MATERIAL_AMOUNT * MINIMUM_VALUE_MULT) // bobaEDIT: magic number replacement
	if(!isnull(mat.minimum_value_override))
		price_minimum = round(mat.minimum_value_override * SHEET_MATERIAL_AMOUNT)
	var/price_maximum = round(mat.value_per_unit * SHEET_MATERIAL_AMOUNT * MAXIMUM_VALUE_MULT) // bobaEDIT: magic number replacement
...
#undef MINIMUM_VALUE_MULT // bobaEDIT: used in price min/max declarations
#undef MAXIMUM_VALUE_MULT // bobaEDIT: used in price min/max declarations
