...
/datum/controller/subsystem/statpanels/proc/set_status_tab(client/target)
	...
	target.stat_panel.send_message("update_stat", list(
		"global_data" = (target.byond_version < 517) ? global_data : (global_data + beta_notice), // NOVA EDIT CHANGE - ORIGINAL: "global_data" = (target.byond_version < 516) ? global_data : (global_data + beta_notice),
