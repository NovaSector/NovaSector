...
/proc/init_main_girder_wall_recipes()
	return create_girder_wall_recipes(
		wall_types = list(
			...
			// NOVA EDIT ADDITION START - FLOORS_AND_WALLS - walls removed by tgstation #97723
		...
		falsewall_types = list(
			...
			// NOVA EDIT ADDITION START - FLOORS_AND_WALLS - false walls removed by tgstation #97723
