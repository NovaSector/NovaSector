...
GLOBAL_LIST_INIT(common_loot, list( //common: basic items
	list(//tools
		...
		/obj/item/wrench = 1,
		/obj/item/multitool/fock = 1, // bobaEDIT ADDITION
		/obj/item/weldingtool/electric/arc_welder = 1, // bobaEDIT ADDITION
		/obj/item/crowbar/large/doorforcer = 1, // bobaEDIT ADDITION
		) = 1,
	...
	list(//equipment
		...
		/obj/item/clothing/mask/gas/atmos/frontier_colonist = 1, // bobaEDIT ADDITION
		/obj/item/radio/headset/headset_frontier_colonist = 1, // bobaEDIT ADDITION
		/obj/item/clothing/suit/frontier_colonist_flak = 1, // bobaEDIT ADDITION
		/obj/item/clothing/head/frontier_colonist_helmet = 1, // bobaEDIT ADDITION
		/obj/item/storage/pouch/cin_general = 1, // bobaEDIT ADDITION
		) = 1,
	...
	list(//medical and chemicals
		...
		/obj/item/disk/neuroware/pumpup = 1, // bobaEDIT ADDITION
		/obj/item/storage/medkit/civil_defense/stocked = 1, // bobaEDIT ADDITION
		/obj/item/storage/medkit/frontier/stocked = 1, // bobaEDIT ADDITION
		/obj/item/storage/medkit/combat_surgeon/stocked = 1, // bobaEDIT ADDITION
		/obj/item/stack/medical/suture = 1, // bobaEDIT ADDITION
		/obj/item/stack/medical/ointment/red_sun = 1, // bobaEDIT ADDITION
		/obj/item/reagent_containers/hypospray/medipen/deforest/morpital = 1, // bobaEDIT ADDITION
		/obj/item/reagent_containers/hypospray/medipen/deforest/aranepaine = 1, // bobaEDIT ADDITION
		) = 1,
...
GLOBAL_LIST_INIT(uncommon_loot, list(//uncommon: useful items
	list(//tools
		...
		/obj/item/melee/baton/security/stun_gun/stun_knife = 1, // bobaEDIT ADDITION
		/obj/item/melee/baton/security/stun_gun = 1, // bobaEDIT ADDITION
		/obj/item/gun/energy/taser/crank = 1, // bobaEDIT ADDITION
		/obj/item/gun/ballistic/automatic/pistol/doorhickey = 1, // bobaEDIT ADDITION, yes it's lower in the code too, but it should be alot more common now
		) = 8,
...
#define maint_trash_weight 1200 // bobaEDIT CHANGE - Made these two alot less common so you get more varied items, does make oddities alot more common aswell - Original: maint_trash_weight 4500
#define maint_common_weight 1200 // bobaEDIT CHANGE - Made these two alot less common so you get more varied items does make oddities alot more common aswell - Original: maint_common_weight 4500
