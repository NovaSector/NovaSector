...
/datum/species/lizard/get_species_lore()
	return list(
		"The Tizirans, an ancient lizard-like species, originated on the desert world of Tizira and developed a complex society rooted in spirituality and nature. Their history is marked by two major ideologies: The Daysong Way, focused on collective action and unity, and Takuhism, emphasizing personal growth and harmony with nature. Over centuries, Tiziran society evolved from nomadic clans to an advanced civilization, achieving space travel by the 2360s. However, internal divisions deepened between the two philosophies, leading to a cultural schism. As the Tizirans began colonizing space, factions broke away, forming the Unathi and Ashwalkers. This split weakened their unity, ultimately contributing to their vulnerability during the Terran War, a devastating conflict with humanity that would shatter their moon, Atra'Kor, and leave their civilization in turmoil.",
		"During the Terran War, the Tizirans fought a brutal conflict with humanity over territory and survival, which culminated in the destruction of their sacred moon, Atra'Kor. This event caused massive devastation to their home planet and deeply scarred their society. The war ended with the Sagittarius Accords, which imposed a demilitarized zone (DMZ) and heavy trade restrictions on the Tizirans, limiting their expansion and influence. In the aftermath, the Tiziran government collapsed, giving rise to the Talunan Imperium. The Imperium is a more decentralized system, with power divided between the Imperial Throne and local Wards, which handle daily governance. The Imperium focuses on rebuilding, maintaining a strong military presence, and carefully managing relations with other species, especially their allies, the Teshari, while remaining distrustful of humanity and other outsiders.",
		"After the Terran Conflict, the Tiziran people restructured their government into the Talunan Imperium. Power is centralized under the Imperial Throne, while local governance is managed by small, self-organized communities called Wards. All citizens must complete a five-year civil service period, which can involve tasks like infrastructure maintenance, peacekeeping, or emergency services.",
		"Talunan flagged vessels are prohibited from crossing the DMZ per the Sagittarius Accords. As a result, there is no official Talunan presence North of their border with SolFed. Unofficially the joint Tiziro-Teshari arm of the Expeditionary Corps acts to fulfill Talunan objectives in and beyond human space.",
