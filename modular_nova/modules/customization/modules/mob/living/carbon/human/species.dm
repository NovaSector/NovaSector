...
/datum/species/human/New()
	. = ..()
	inherent_traits -= list(TRAIT_USES_SKINTONES)
	inherent_traits |= list(TRAIT_MUTANT_COLORS)

/datum/species/human/randomize_features()
	var/list/features = ..()
	features[FEATURE_MUTANT_COLOR] = skintone2hex(pick(GLOB.skin_tones))
	return features

/datum/species/human/prepare_human_for_preview(mob/living/carbon/human/dummy)
	..()
	dummy.dna.features[FEATURE_MUTANT_COLOR] = skintone2hex("caucasian1")

/mob/living/carbon/human/Initialize(mapload)
	. = ..()
	dna.features[FEATURE_MUTANT_COLOR] = skintone2hex(skin_tone)
	update_body(is_creating = TRUE)

/datum/species/human/vampire/randomize_features()
	var/list/features = ..()
	features[FEATURE_MUTANT_COLOR] = skintone2hex("albino")
	return features

/datum/species/human/vampire/prepare_human_for_preview(mob/living/carbon/human/dummy)
	..()
	dummy.dna.features[FEATURE_MUTANT_COLOR] = skintone2hex("albino")
...
/datum/species/dullahan/prepare_human_for_preview(mob/living/carbon/human/dummy)
	..()
	dummy.dna.features[FEATURE_MUTANT_COLOR] = skintone2hex("caucasian1")
