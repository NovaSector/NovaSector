...
/obj/item/clothing/suit/hooded/seva/melon
	...
	desc = "A SEVA suit originally designed for SolFed's Army Corps of Engineers. This specific suit was designed for work in more hostile environments and allow greater field of view. This suit seems to have had it's typical armor plating removed in favor of movement. "
	icon = 'modular_nova/master_files/icons/donator/obj/clothing/suits.dmi'
	worn_icon = 'modular_nova/master_files/icons/donator/mob/clothing/suit.dmi'
	worn_icon_muzzled = 'modular_nova/master_files/icons/donator/mob/clothing/suit_digi.dmi'
