/obj/item/mod/module/hypno_visor
	...
	icon = 'modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_modsuit/mod_modules.dmi'
	...
	overlay_icon_file = 'modular_nova/modules/modular_items/lewd_items/icons/obj/lewd_modsuit/mod_modules.dmi'
	var/hypno_message
...
/obj/item/mod/module/hypno_visor/Destroy()
	...
	if(mod.wearer && part_activated)
		mod.wearer.cure_trauma_type(/datum/brain_trauma/hypnosis, TRAUMA_RESILIENCE_SURGERY)
	return ..()
...
/obj/item/mod/module/hypno_visor/on_part_activation()
	if(!mod.wearer.client?.prefs?.read_preference(/datum/preference/toggle/erp/sex_toy))
	...
	if(hypno_message == "" || isnull(hypno_message))
		hypno_message = "Obey"
	mod.wearer.gain_trauma(new /datum/brain_trauma/hypnosis(hypno_message), TRAUMA_RESILIENCE_SURGERY)
