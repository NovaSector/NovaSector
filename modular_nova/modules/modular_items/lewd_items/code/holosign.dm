...
/obj/structure/holosign/barrier/erp
	name = "privacy holobarrier"
	desc = "A holographic privacy barrier that implies someone is enjoying an intimate moment. It would be respectful to go no further."
