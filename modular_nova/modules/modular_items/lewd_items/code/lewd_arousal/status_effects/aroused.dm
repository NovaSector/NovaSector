...
#define NO_LIBIDO_PLEASURE_OFFSET 50
...
/datum/status_effect/aroused/tick(seconds_between_ticks)
	...
	if(HAS_TRAIT(affected_mob, TRAIT_NO_LIBIDO))
		temp_pleasure -= NO_LIBIDO_PLEASURE_OFFSET
		temp_arousal -= NO_LIBIDO_PLEASURE_OFFSET
...
#undef NO_LIBIDO_PLEASURE_OFFSET
