	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/straight_jacket/kinky_sleepbag = 3, //my favorite thing, spent 1 month on it. Don't remove please.
			...
			"products" = list(
				...
				/obj/item/reagent_containers/cup/bottle/crocin = 12,
				/obj/item/reagent_containers/cup/bottle/camphor =6,
				...
				/obj/item/reagent_containers/cup/bottle/hexacrocin = 6,
				/obj/item/reagent_containers/cup/bottle/pentacamphor = 3,
