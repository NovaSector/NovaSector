...
/datum/sprite_accessory/ears/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
...
/datum/sprite_accessory/frills/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
...
/datum/sprite_accessory/head_accessory/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
...
/datum/sprite_accessory/horns/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.) // If true, horns already hidden
		return lewd_is_hidden(target_human)

// Extends default proc check for hidden antenna for supporting our sleepbag and catsuit too
/datum/sprite_accessory/antenna/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
...
/datum/sprite_accessory/moth_antennae/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
...
/datum/sprite_accessory/skrell_hair/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.) // If true, skrell hair already hidden
		return lewd_is_hidden(target_human)

// Extends default proc check for hidden skrell hair for supporting our sleepbag and catsuit too
/datum/sprite_accessory/tails/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.) // If true, tail already hidden
		return lewd_is_hidden(target_human, hide_if_catsuit = FALSE)

/datum/sprite_accessory/xenodorsal/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.)
		return lewd_is_hidden(target_human)

/datum/sprite_accessory/xenohead/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.)
...
/datum/sprite_accessory/wings/is_hidden(mob/living/carbon/human/target_human, datum/bodypart_overlay/mutant/bodypart_overlay)
	. = ..()
	if(!.)
		return lewd_is_hidden(target_human)
