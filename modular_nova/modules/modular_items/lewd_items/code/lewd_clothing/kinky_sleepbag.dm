/obj/item/clothing/suit/straight_jacket/kinky_sleepbag
	...
	flags_inv = HIDEHEADGEAR|HIDENECK|HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT|HIDESUITSTORAGE|HIDEHAIR|HIDESEXTOY|HIDETAIL|HIDEFOURARMS // NOVA EDIT ADDITION - HIDETAIL, HIDEFOURARMS
	strip_delay = 300
