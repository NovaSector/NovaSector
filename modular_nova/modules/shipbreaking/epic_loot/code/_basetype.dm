/obj/structure/maintenance_loot_structure
	...
	icon = 'modular_nova/modules/shipbreaking/epic_loot/icons/loot_structures.dmi'
	density = TRUE
	anchored = TRUE
...
/datum/storage/maintenance_loot_structure
	...
	var/opening_sound = 'modular_nova/modules/shipbreaking/epic_loot/sound/plastic.mp3'
...
/obj/item/epic_loot
	...
	icon = 'modular_nova/modules/shipbreaking/epic_loot/icons/epic_loot.dmi'
