...
/datum/shipbreaking_owner/mining/kahraman
	owner_name = "Kahraman Heavy Industry"
	ship_primary_colour = "#820a16"
	ship_secondary_colour = "#e3ddc3"

/datum/shipbreaking_owner/mining/exagon
	owner_name = "Exagon-Ichikawa Orbital Resourcing"
