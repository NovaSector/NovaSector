...
/datum/reagent/drug/cocaine/on_mob_life(mob/living/carbon/affected_mob, seconds_per_tick)
	. = ..()
...
/datum/reagent/drug/cocaine/overdose_process(mob/living/affected_mob, seconds_per_tick)
	. = ..()
