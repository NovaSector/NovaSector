...
/mob/living/basic/drone/babylon/Initialize(mapload)
	...
	AddComponent(
		...
		PUNISHMENT_GIB,
		"01000110 01010101 01000011 01001011 00100000 01011001 01001111 01010101\
		<br>WARNING: Dereliction of BS13 detected. Self-destruct activated."
	)
