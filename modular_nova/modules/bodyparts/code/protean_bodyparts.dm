...
/obj/item/bodypart/chest/robot/protean
	...
	/// Reference to this protean's modsuit, stored here so the species datum remains stateless.
...
/obj/item/bodypart/leg/right/robot/protean
	...
	/// Timerid of the queued deletion, so we can clean it up if we have to
	var/qdel_timerid
