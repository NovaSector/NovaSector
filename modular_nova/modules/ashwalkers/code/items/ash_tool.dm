...
/obj/item/chisel/ashwalker
	...
	desc = "Where there is a will there is a way, the tool head is fashioned from bone shaped when it was fresh and left to calcify in iron rich water to make a strong head for all your carving needs."
	icon = 'modular_nova/modules/ashwalkers/icons/ashwalker_tools.dmi'
	icon_state = "chisel"
	custom_materials = list(/datum/material/bone = SMALL_MATERIAL_AMOUNT * 1)
