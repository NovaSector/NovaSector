...
/datum/config_entry/string/alert_gamma_downto
	config_entry_value = "The Solar Federation has released Military Command of the station, the Solar Federation has detected and declared a ZK-Class Reality Failure Scenario. Security Personnel is authorized full access to lethal equipment to enforce Martial Law. Failure to follow emergency procedures is punishable by death. This is not a drill."
...
/datum/config_entry/string/alert_epsilon_downto
	config_entry_value = "The Solar Federation has released Military Command and action over the station. Central Command is now in full command authority of the station, comply with all instructions from Nanotrasen Central Command staff, Crew cooperation is compulsory! Have a Secure Day!"
