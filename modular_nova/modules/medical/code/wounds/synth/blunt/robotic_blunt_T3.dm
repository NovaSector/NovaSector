/datum/wound/blunt/robotic/secures_internals/critical
	...
	treat_text_short = "Repair surgically, start by superheating the limb until you can mold it by aggresively grabbing it and follow the tier 2 wound instructions when it's done, use gauze to reduce negative effects."
