...
/datum/round_event_control/cargo_pod
	...
	var/list/category_adds_by_level = list(
		...
		list( // HIGH
			...
			CARGO_NEED_MORALE = list(/obj/machinery/vending/snack = 1, /obj/item/toy/plush/human = 2),
		...
		list( // EXTREME
			...
			CARGO_NEED_RESEARCH = list(/obj/item/disk/design_disk/modkit_disc = 2, /obj/item/stock_parts/scanning_module/phasic = 1)
		)
	)
	...
	var/list/category_boosts_by_level = list(
		...
		list( // HIGH
			...
			CARGO_NEED_MORALE = list(/obj/item/toy/plush/human),
		...
		list( // EXTREME
			...
			CARGO_NEED_MORALE = list(/obj/item/storage/box/donkpockets),
			CARGO_NEED_RESEARCH = list(/obj/item/disk/design_disk/modkit_disc)
		)
	)
