...
/obj/item/ammo_box/advanced/s12gauge/antitide
	name = "Lighting shot ammo box"
	desc = "A box of 15 lighting shot shells. These are less-lethal and will shot a cable that embeds in target, causing pain while its connected."
	icon_state = "antitide"
