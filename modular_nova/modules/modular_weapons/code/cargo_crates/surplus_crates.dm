...
/datum/supply_pack/imports/budgeted
	...
	contains = list(
		// Clothing
		/obj/item/clothing/under/syndicate/rus_army = ITEM_WEIGHT_CLOTHING,
		/obj/item/storage/belt/military = ITEM_WEIGHT_CLOTHING,
		...
		// Armors
		/obj/item/clothing/head/helmet/rus_helmet = ITEM_WEIGHT_ARMOR,
		/obj/item/clothing/suit/armor/vest/russian = ITEM_WEIGHT_ARMOR,
		/obj/item/clothing/head/helmet/nri_police = ITEM_WEIGHT_ARMOR,
		/obj/item/clothing/suit/armor/vest/nri_police = ITEM_WEIGHT_ARMOR,
		// Weapons
		/obj/item/storage/toolbox/guncase/soviet = ITEM_WEIGHT_GUN_COMMON,
		// Ammo
