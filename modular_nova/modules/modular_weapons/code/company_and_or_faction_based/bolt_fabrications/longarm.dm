/obj/item/gun/ballistic/automatic/type213
	...
	desc = "A completly non lethal longarm used by Sol Fed Peacekeeping forces. It uses kinetic rounds to temporarily disable adversaries. Made as a companion to the Type 207 Kinetic Pistol."
