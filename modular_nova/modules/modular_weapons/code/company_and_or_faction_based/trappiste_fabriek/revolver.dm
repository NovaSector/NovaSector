...
/obj/item/gun/ballistic/revolver/bluvolva
	name = "\improper DéFender Revolver"
	...
	lore_blurb = "The Defoncé was designed to fulfill a request by the Sol Federation Armed Forces for a maintainable high-caliber handgun.<br><br>\
		Although it served its purpose well, complaints were received from NT staff regarding its unwieldiness in combat situations. \
		The DéDender was made on custom order from Nanotrasen to distribute to junior members of their Asset Protection program. \
