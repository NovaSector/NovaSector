...
/obj/item/clothing/neck/necklace/hearthkin/proc/on_necklace_equip(datum/source, mob/living/carbon/human/equipper, slot)
	...
	to_chat(equipper, span_boldnotice("You feel the alien unease lessen as the gem loses its interest in you after removing it. The eye closes, and your mind does as well, losing its grasp of Hearthkin."))
