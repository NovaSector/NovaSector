/obj/effect/spawner/random/maintsrooms
	...
	loot = list(
		...
		/mob/living/basic/mining/legion/houndoftindalos = 0.6,
		...
		/obj/item/stack/sheet/mineral/zaukerite = 0.2,
		/obj/item/stack/sheet/mineral/runite = 0.2,
		/obj/item/stack/sheet/mineral/gold = 0.3,
		/obj/item/stack/sheet/mineral/diamond = 0.2,
		/obj/item/stack/sheet/mineral/adamantine = 0.2,
		/obj/item/stack/sheet/hauntium = 0.2,
		/obj/item/stack/telecrystal = 0.2,
		/obj/item/stack/ore/bluespace_crystal = 0.2,
	)
