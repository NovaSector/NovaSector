/obj/effect/spawner/random/maintsrooms
	...
	loot = list(
		...
		/mob/living/basic/mining/legion/houndoftindalos = 0.25,
		/mob/living/basic/blankbody/shaggoth = 0.25,
		...
		/obj/item/stack/sheet/mineral/metal_hydrogen = 0.2,
		/obj/item/stack/sheet/mineral/gold = 0.2,
