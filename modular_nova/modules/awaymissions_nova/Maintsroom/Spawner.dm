/obj/effect/spawner/random/maintsrooms
	...
	loot = list(
		...
		/obj/item/stack/sheet/mineral/plastitanium	=	0.1,
		...
		/obj/item/stack/ammonia_crystals	=	0.1,
		/obj/item/nitrium_crystal	=	0.1,
		/obj/item/hypernoblium_crystal	=	0.1,
		/obj/item/grenade/gas_crystal/proto_nitrate_crystal	=	0.1,
