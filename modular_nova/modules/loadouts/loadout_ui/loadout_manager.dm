...
/datum/loadout_manager/ui_static_data()
	...
	loadout_tabs += list(list("name" = "Signature", "title" = "Signature Character Items ([MAX_ALLOWED_SIGNATURE_ITEMS] max)", "contents" = list_to_data(GLOB.loadout_signature))) //// Lethalstation addition
