...
/datum/loadout_item/head/rose
	name = "Flower - Rose" //TG overwrite of name to sort
	group = "Miscellaneous"

/datum/loadout_item/head/sunflower
	name = "Flower - Sunflower" //TG overwrite of name to sort
	group = "Miscellaneous"

/datum/loadout_item/head/poppy
	name = "Flower - Poppy" //TG overwrite of name to sort
	group = "Miscellaneous"

/datum/loadout_item/head/lily
	name = "Flower - Lily" //TG overwrite of name to sort
	group = "Miscellaneous"

/datum/loadout_item/head/geranium
	name = "Flower - Geranium" //TG overwrite of name to sort
	group = "Miscellaneous"

/datum/loadout_item/head/harebell
	name = "Flower - Harebell" //TG overwrite of name to sort
	group = "Miscellaneous"
...
/datum/loadout_item/head/bear_pelt
	name = "Pelt - Bear (Space)" //TG overwrite of name to sort
	group = "Costumes"
