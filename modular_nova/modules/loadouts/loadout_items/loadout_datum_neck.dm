...
/datum/loadout_item/neck/greyscale_large
	name = "Scarf - Large  (Colorable)" //TG overwrite of name to sort
...
/datum/loadout_item/neck/necktie
	name = "Tie - Neck, Colorable" //TG overwrite of name to sort
...
/datum/loadout_item/neck/discoproper
	name = "Tie - Necktie, Horrible"
	item_path = /obj/item/clothing/neck/tie/disco

/datum/loadout_item/neck/necktie_loose
	name = "Tie - Necktie, Loose" //TG overwrite of name to sort

/datum/loadout_item/neck/necktie_disco
	name = "Tie - Necktie, Ugly" //TG overwrite of name to sort
...
/*
*	CLOAKS, ROBES, VEILS, AND SHROUDS!
*/

/datum/loadout_item/neck/gags_boat
	name = "Boatcloak (Colorable)"
	item_path = /obj/item/clothing/neck/cloak/colourable/boat
	group = "Cloaks" //Don't even get into the semantics with me. It's close enough to group them together
...
/datum/loadout_item/neck/tesharian_mantle
	name = "Mantle - Tesharian (Colorable)"
