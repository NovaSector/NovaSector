...
/proc/spawn_sapper_gang()
	var/list/candidates = SSpolling.poll_ghost_candidates("Do you wish to be considered for a [span_notice("sapper gang?")]", check_jobban = ROLE_TRAITOR, alert_pic = /obj/item/wrench/bolter, role_name_text = "sapper gang")
