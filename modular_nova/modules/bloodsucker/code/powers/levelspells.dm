...
/datum/action/cooldown/vampire/targeted/scourgify/fire_targeted_power(atom/target_atom)
	...
	if(vassal) // We don't need to ask a lowly vassal.
		...
		scourgedatum.can_assign_self_objectives = FALSE
		...
		living_target.playsound_local(null, 'modular_nova/modules/bloodsucker/sound/scourge_offer.ogg', 100, FALSE, pressure_affected = FALSE)
