...
/datum/action/cooldown/vampire/targeted/summon
	...
	ranged_mousepointer = 'modular_nova/modules/bloodsucker/icons/mouse_pointers/vampire_summon.dmi'
...
/datum/action/cooldown/vampire/targeted/summon/fire_targeted_power(atom/target_atom)
	...
	carbon_target.playsound_local(null, 'modular_nova/modules/bloodsucker/sound/mesmerize.ogg', 70, FALSE, pressure_affected = FALSE)
