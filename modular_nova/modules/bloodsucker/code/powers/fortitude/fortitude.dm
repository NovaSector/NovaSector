...
/datum/action/cooldown/vampire/fortitude/activate_power()
	...
	owner.playsound_local(null, 'modular_nova/modules/bloodsucker/sound/fortitude_on.ogg', 100, FALSE, pressure_affected = FALSE)
...
/datum/action/cooldown/vampire/fortitude/deactivate_power()
	...
	owner.playsound_local(null, 'modular_nova/modules/bloodsucker/sound/fortitude_off.ogg', 100, FALSE, pressure_affected = FALSE)
