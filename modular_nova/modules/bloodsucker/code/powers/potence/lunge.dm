...
/datum/action/cooldown/vampire/targeted/lunge
	...
	ranged_mousepointer = 'modular_nova/modules/bloodsucker/icons/mouse_pointers/vampire_lunge.dmi'
...
/datum/action/cooldown/vampire/targeted/lunge/proc/lunge_end(atom/hit_atom, turf/target_turf)
	...
	if(IS_CURATOR(target) || HAS_TRAIT(target, TRAIT_BRAWLING_KNOCKDOWN_BLOCKED))
