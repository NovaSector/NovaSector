/datum/objective
	...
	var/default_opt_in_level = ANTAG_OPT_IN_YES_KILL
...
/datum/objective/proc/opt_in_valid(datum/mind/target_mind)
	return (get_opt_in_level(target_mind) <= target_mind.get_effective_antag_opt_in_level())

// ROUND REMOVE
/datum/objective/maroon
	default_opt_in_level = ANTAG_OPT_IN_YES_ROUND_REMOVE
...
/datum/objective/assassinate
	default_opt_in_level = ANTAG_OPT_IN_YES_KILL
...
/datum/objective/protect
	default_opt_in_level = ANTAG_OPT_IN_YES_PARTIAL
...
// Contractors can grab anyone opted in to being killed or worse, on top of the Sec/Command roles they can always take.
/datum/objective/contract/opt_in_valid(datum/mind/target_mind)
	if(target_mind.get_effective_antag_opt_in_level() >= ANTAG_OPT_IN_YES_KILL)
		return TRUE
