...
- antag_opt_in - lives in ~nova_defines located in `__DEFINES` folder. Defines named OPT_IN_YES_ANTAG, OPT_IN_YES_ROUND_REMOVE, and OPT_IN_OPT_IN_NOT_TARGET - used for managing opt in stuff.
