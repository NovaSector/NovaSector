...
/obj/machinery/arc_furnace/default_deconstruction_screwdriver(mob/user, obj/item/screwdriver)
	return NONE

/obj/machinery/arc_furnace/default_deconstruction_crowbar(mob/living/user, obj/item/crowbar)
	return NONE

/obj/machinery/arc_furnace/default_pry_open(mob/living/user,
	obj/item/crowbar,
