/obj/machinery/power/port_gen/pacman/solid_fuel
	...
	desc = "TThe second most common generator design in the galaxy, second only to the P.A.C.M.A.N. \
		...
		This however comes at a cost of being more resource intensive to produce allowing for clean power generation and must be <b>bolted to the ground<b> in order to function. \
