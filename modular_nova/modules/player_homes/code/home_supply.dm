 ...
 * console calls down a drop pod of materials or tools on a cooldown, no approval needed. Anything
 * past the basics - refined alloys, an RCD, or a written request for something odd - goes to the
 * admins with approve and deny buttons instead of shipping straight away.
 *
