...
// Allows players to cryo others. Checks if they have been AFK for 30 minutes.
	...
	to_chat(target, span_warning("<b>If you remain in the pod for [time_till_despawn / SECONDS] seconds, your character will be permanently removed from the round.</b>"))
