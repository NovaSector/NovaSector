...
/datum/reagent/drug/methamphetamine/borer_version/on_mob_life(mob/living/carbon/M, seconds_per_tick, times_fired)
	...
	M.AdjustStun(-4 SECONDS * REM * seconds_per_tick)
	M.AdjustKnockdown(-4 SECONDS * REM * seconds_per_tick)
	M.AdjustUnconscious(-4 SECONDS * REM * seconds_per_tick)
	M.AdjustParalyzed(-4 SECONDS * REM * seconds_per_tick)
	M.AdjustImmobilized(-4 SECONDS * REM * seconds_per_tick)
