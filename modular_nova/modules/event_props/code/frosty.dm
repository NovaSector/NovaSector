/// Worn by anything that keeps you warm enough to shrug off a frosty area.
...
/obj/machinery/drone_dispenser/binoculars/pamphlet
	...
	end_create_message = "dispenses a handy informational brochure."
