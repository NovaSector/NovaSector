...
/datum/preference/choiced/voice_type/apply_to_human(mob/living/carbon/human/target, value, datum/preferences/preferences)
	return
...
/datum/preference/toggle/fallback_to_blooper/is_accessible(datum/preferences/preferences)
	if(!..(preferences))
		return
	return (preferences.read_preference(/datum/preference/choiced/voice_type) == VOICE_TYPE_TTS)
...
/datum/preference/choiced/blooper/apply_to_human(mob/living/carbon/human/target, value, datum/preferences/preferences) // don't apply this to people who don't have it enabled
	var/voice_type_pref = preferences.read_preference(/datum/preference/choiced/voice_type)
