...
/datum/supply_pack/science/protean_vessel
	name = "Protean Vessel"
	desc = "Contains a blank protean body, the refactory on its last legs, just stable enough to receive a core. It will quickly deteriorate as soon as the core goes inside."
