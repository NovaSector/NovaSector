	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/head/costume/nova/pink_clown_wig = 1,
				/obj/item/clothing/head/beret/clown = 1,
				/obj/item/clothing/under/rank/civilian/clown/jesteralt = 1,
				/obj/item/clothing/under/rank/civilian/clown/pink_clown_outfit = 1,
				/obj/item/clothing/shoes/clown_shoes/pink/heels = 1,
				/obj/item/clothing/gloves/pink_clown = 1,
			),
		),
		list(
			"name" = "Fancy",
