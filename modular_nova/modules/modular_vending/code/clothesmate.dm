	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/toggle/jacket/croptopbomberjacket_stripe = 5,
				/obj/item/clothing/suit/toggle/jacket/croptopbomberjacket_badge = 5,
				/obj/item/clothing/suit/toggle/jacket/croptopbomberjacket_plain = 5,
