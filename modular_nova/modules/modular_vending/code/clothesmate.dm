	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/toggle/jacket/croptop_bomber_jacket_stripe = 5,
				/obj/item/clothing/suit/toggle/jacket/croptop_bomber_jacket_badge = 5,
				/obj/item/clothing/suit/toggle/jacket/croptop_bomber_jacket_plain = 5,
