	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/jacket/long_robe/transparent = 5,
				/obj/item/clothing/suit/jacket/haori/split = 5,
				/obj/item/clothing/suit/jacket/haori = 5,
				/obj/item/clothing/suit/jacket/haori/split/transparent = 5,
				/obj/item/clothing/suit/jacket/haori/transparent = 5,
