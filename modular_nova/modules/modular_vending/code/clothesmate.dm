	...
	product_categories_nova = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/suit/jacket/transparent_long_robe = 5,
				/obj/item/clothing/suit/jacket/split_haori = 5,
				/obj/item/clothing/suit/jacket/haori = 5,
				/obj/item/clothing/suit/jacket/transparent_split_haori = 5,
				/obj/item/clothing/suit/jacket/transparent_haori = 5,
