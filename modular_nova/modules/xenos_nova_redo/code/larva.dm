/// NOVA SECTOR MODULE NOVA_XENO_REDO
...
/datum/action/cooldown/alien/larva_evolve/Activate(atom/target)
	...
	if(!caste_options)
		...
		caste_name = "Runner",
		caste_image = image(icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi', icon_state = "preview_runner"),
		...
		make_xeno_caste_entry(
		caste_name = "Sentinel",
		caste_image = image(icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi', icon_state = "preview_sentinel"),
		...
		make_xeno_caste_entry(
		caste_name = "Defender",
		caste_image  = image(icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi', icon_state = "preview_defender"),
		...
		make_xeno_caste_entry(
		caste_name = "Drone",
		caste_image  = image(icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi', icon_state = "preview_drone"),
