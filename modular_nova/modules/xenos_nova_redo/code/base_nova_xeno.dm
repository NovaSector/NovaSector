...
/mob/living/carbon/alien/adult/nova
	...
	icon = 'modular_nova/modules/xenos_nova_redo/icons/big_xenos.dmi'
	...
	var/alt_inhands_file = 'modular_nova/modules/xenos_nova_redo/icons/big_xenos.dmi'
...
/mob/living/carbon/alien/adult/nova/update_fire_overlay(stacks, on_fire, last_icon_state, suffix = "")
