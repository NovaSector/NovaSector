...
/datum/action/cooldown/alien/nova/queen_screech/Activate()
	...
	playsound(queenie, 'modular_nova/modules/xenos_nova_redo/sound/alien_queen_screech.ogg', 100, FALSE, 8, 0.9)
...
/mob/living/carbon/alien/adult/nova/proc/create_shriekwave()
	...
	overlays_standing[HALO_LAYER] = image("icon" = 'modular_nova/modules/xenos_nova_redo/icons/big_xenos.dmi', "icon_state" = "shriek_waves") //Ehh, suit layer's not being used.
