...
/datum/action/cooldown/alien/nova/warrior_agility/proc/begin_agility()
	...
	playsound(agility_target, 'modular_nova/modules/xenos_nova_redo/sound/alien_hiss.ogg', 100, TRUE, 8, 0.9)
...
/datum/action/cooldown/alien/nova/warrior_agility/proc/end_agility()
	...
	playsound(agility_target, 'modular_nova/modules/xenos_nova_redo/sound/alien_roar2.ogg', 100, TRUE, 8, 0.9) //Warrior runs up on all fours, stands upright, screams at you
