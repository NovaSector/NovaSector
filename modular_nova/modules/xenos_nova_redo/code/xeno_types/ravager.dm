...
/datum/action/cooldown/mob_cooldown/charge/triple_charge/ravager
	...
	charge_damage = 25
	button_icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi'
...
/datum/action/cooldown/mob_cooldown/charge/triple_charge/ravager/do_charge_indicator(atom/charger, atom/charge_target)
	playsound(charger, 'modular_nova/modules/xenos_nova_redo/sound/alien_roar2.ogg', 100, TRUE, 8, 0.9)
...
/obj/effect/temp_visual/dir_setting/tailsweep/ravager
	icon = 'modular_nova/modules/xenos_nova_redo/icons/xeno_actions.dmi'
...
/datum/action/cooldown/alien/nova/literally_too_angry_to_die/Activate()
	...
	playsound(owner, 'modular_nova/modules/xenos_nova_redo/sound/alien_roar1.ogg', 100, TRUE, 8, 0.9)
