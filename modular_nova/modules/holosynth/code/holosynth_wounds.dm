...
/datum/wound/robotic_blunt/update_descriptions()
	. = ..()
	apply_holosynth_flavor()

/datum/wound/robotic_bleed/update_descriptions()
	. = ..()
	apply_holosynth_flavor()
