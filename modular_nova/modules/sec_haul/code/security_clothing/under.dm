...
/datum/atom_skin/security_plaid_skirt
	abstract_type = /datum/atom_skin/security_plaid_skirt

/datum/atom_skin/security_plaid_skirt/blue
	preview_name = "Blue Variant"
	new_icon_state = "plain_skirt_blue"

/datum/atom_skin/security_plaid_skirt/black
	preview_name = "Black Variant"
...
/obj/item/clothing/under/rank/security/nova/skirt/plain/Initialize(mapload)
	. = ..()
	AddComponent(/datum/component/reskinable_item, /datum/atom_skin/security_plaid_skirt)
