...
/datum/preference/toggle/naga_soles/is_accessible(datum/preferences/preferences)
	...
	var/datum/sprite_accessory/taur_mode = SSaccessories.sprite_accessories[FEATURE_TAUR][preferences.read_preference(/datum/preference/choiced/mutant_choice/taur)]
