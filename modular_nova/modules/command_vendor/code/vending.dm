...
/obj/machinery/vending/access/command/build_access_list(list/access_lists)
	...
	access_lists[ACCESS_HOP] = list( // Best head btw
		...
		/obj/item/clothing/under/rank/captain/nova/imperial/skirt/hopskirt = 1,
	...
	access_lists[ACCESS_CE] = list(
		...
		/obj/item/clothing/under/rank/captain/nova/imperial/generic/ce = 1,
		/obj/item/clothing/under/rank/captain/nova/imperial/skirt/ceskirt = 1,
