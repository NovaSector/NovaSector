...
#define FLESHCORE_SPREAD_PROGRESS_PER_SUBSYSTEM_FIRE 30 // Every subsystem fire, how much progress do we gain?
#define FLESHCORE_BASE_SPREAD_PROGRESS_PER_SUBSYSTEM_FIRE 30 // The baseline of the above.
