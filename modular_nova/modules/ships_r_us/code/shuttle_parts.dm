/area/shuttle/personally_bought
	...
	ambient_buzz = 'modular_nova/modules/ships_r_us/sound/amb_ship_01.ogg'
	ambient_buzz_vol = 50
	ambientsounds = list(
		'modular_nova/modules/ships_r_us/sound/alarm_radio.ogg',
		'modular_nova/modules/ships_r_us/sound/gear_loop.ogg',
		'modular_nova/modules/ships_r_us/sound/gear_start.ogg',
		'modular_nova/modules/ships_r_us/sound/gear_stop.ogg',
		'modular_nova/modules/ships_r_us/sound/intercom_loop.ogg',
	)
...
/obj/structure/railing/eva_handhold
	...
	icon = 'modular_nova/modules/ships_r_us/icons/ship_items.dmi'
	icon_state = "eva_rail"
	max_integrity = 50
