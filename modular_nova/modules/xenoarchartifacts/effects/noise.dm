/datum/artifact_effect/noise
	...
	var/static/list/possible_noises = list(
		...
		'modular_nova/modules/random_ship_event/random_ships/nri/sounds/alarm_radio.ogg',
		'modular_nova/modules/random_ship_event/random_ships/nri/sounds/morse.ogg', // I can spend all day here, adding sounds. But i wont.
	)
