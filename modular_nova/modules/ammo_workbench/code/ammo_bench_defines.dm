...
/// This bitflag is for "unarmored" ammo, which are assumed to be good against unarmored or simpler targets, e.g. hollow-points, DumDum rounds, hunting ammo.
...
/// This bitflag is for thermal ammo, which usually relates to adjusting the temperature of their targets, either hot or cold. Usually, it's hot. Generally through fire.
#define AMMO_CATEGORY_THERMAL	(1<<5)
/// This bitflag is for "smart" lethals with some integrated electronic something-or-others, e.g. tracking ammo (.38 TRAC).
#define AMMO_CATEGORY_SMART		(1<<6)
/// This bitflag is for esoteric ammo, e.g. phasic, homing. Probably worth as a supplementary bitflag.
...
/// This ammo is lethal, and has something strange going on with it.
