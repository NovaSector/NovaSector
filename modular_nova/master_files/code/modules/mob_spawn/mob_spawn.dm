...
/obj/effect/mob_spawn/create(mob/mob_possessor, newname, use_loadout = FALSE)
	...
	special(spawned_mob, mob_possessor, use_loadout = use_loadout)
...
/obj/effect/mob_spawn/ghost_role/human/special(mob/living/spawned_mob, mob/mob_possessor, use_loadout = FALSE)
	. = ..(spawned_mob, )
