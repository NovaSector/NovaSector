...
/datum/preference/choiced/brain_type/init_possible_values()
	return list(ORGAN_PREF_POSI_BRAIN, ORGAN_PREF_MMI_BRAIN, ORGAN_PREF_CIRCUIT_BRAIN, ORGAN_PREF_HYPERBOARD_BRAIN, ORGAN_PREF_LIMAENGINE_BRAIN, ORGAN_PREF_DISKBRAIN_BRAIN, ORGAN_PREF_NEUROBOARD_BRAIN, ORGAN_PREF_CONDENSED_BRAIN, ORGAN_PREF_CYBERDECK_BRAIN)
