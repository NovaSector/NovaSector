/datum/trader_data/deathsquadtrader
	...
	initial_products = list(
		/obj/item/raw_anomaly_core/bioscrambler = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/bluespace = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/dimensional = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/ectoplasm = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/flux = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/grav = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/hallucination = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/pyro = list(PAYCHECK_CREW * 80, INFINITY),
		/obj/item/raw_anomaly_core/vortex = list(PAYCHECK_CREW * 80, INFINITY),
