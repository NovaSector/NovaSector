...
/area/ruin/interdyne_planetary_base/cargo/obs/Initialize(mapload)
	if(!ambientsounds)
		...
		ambientsounds += list(
			'modular_nova/modules/random_ship_event/random_ships/nri/sounds/morse.ogg',
...
/area/ruin/interdyne_planetary_base/eng
	...
	ambient_buzz = 'modular_nova/modules/random_ship_event/random_ships/nri/sounds/gear_loop.ogg'
