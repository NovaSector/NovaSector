...
type ServerState = {
  ...
  canOpfor: boolean; // NOVA EDIT ADDITION
  canRespawn: boolean; // NOVA EDIT ADDITION
    ...
    <>
      <div className="escape-menu__home-column">
        ...
        <div className="escape-menu__buttons">
          ...
          {/* NOVA EDIT REMOVAL BEGIN - original: Leave Body button navigating to the generic leave-body page
          <MenuButton
          ...
          {/* NOVA EDIT ADDITION BEGIN - OPFOR/Ghost/Respawn replace the generic Leave Body flow */}
          <MenuButton
            onClick={() => {
              onAction('opfor');
              onClose();
            }}
            disabled={!serverState.canOpfor}
          >
            OPFOR
          </MenuButton>
          <MenuButton
          ...
          <MenuButton
            ...
            disabled={!serverState.canRespawn}
          >
            Respawn
          </MenuButton>
