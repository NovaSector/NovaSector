...
export type LoadoutList = { loadouts: string[]; loadout: LoadoutListInfo }; // NOVA EDIT: Multiple loadout presets: ORIGINAL: export type LoadoutList = Record<typePath, LoadoutListInfo>;
