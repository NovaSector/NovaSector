...
type InterdyneFabricatorData = FabricatorData & {
  hasAccess: BooleanLike;
};

export const InterdyneFabricator = (props) => {
  const { act, data } = useBackend<InterdyneFabricatorData>();
  ...
  return (
    <Window title={fabName} width={670} height={600} theme="interdyne">
      <Window.Content>
        <Stack vertical fill>
          <Stack.Item grow>
            <DesignBrowser
