        ...
        <Section fill>
          ...
          <LabeledList>
            <LabeledList.Item label="Main Sprite Color">
              <Button
                icon="palette"
                onClick={() => act('changeColor')}
                tooltip="Brings up a color pick window to change the main belly sprite color."
              >
          ...
          <NoticeBox>
            Belly sound toggles - these only affect what your belly emits, not
            what you can hear - that's in the global prefs section.
          </NoticeBox>
          <LabeledList>
            ...
            <LabeledList.Item label="Allow Stuffed Gurgles">
              <Button.Checkbox
                ...
                fluid
                onClick={() => act('changeSoundGurgles')}
            ...
            <LabeledList.Item label="Allow Movement Creaks">
              <Button.Checkbox
                ...
                fluid
                onClick={() => act('changeSoundMoveCreaks')}
            ...
            <LabeledList.Item label="Allow Movement Sloshes">
              <Button.Checkbox
                ...
                fluid
                onClick={() => act('changeSoundMoveSloshes')}
          ...
          <LabeledList>
            ...
            <LabeledList.Item label="Full Size">
              <Tooltip
                content="Purely cosmetic full size;
          adds visual size and full creaks/groans."
              >
                <Slider
                  step={0.1}
                  my={1}
            ...
            <LabeledList.Item label="Stuffed Size">
              <Tooltip
                content="Purely cosmetic stuffed size;
          adds visual size, full creaks/groans,
          and stuffed gurgles/churns."
              >
                <Slider
                  step={0.1}
                  my={1}
          ...
          <LabeledList>
            ...
            <LabeledList.Item label={data.endo_size_label}>
              <Tooltip
                content="The default size for a new bellyguest.
            You can change this in-game using the belly settings verb."
              >
                <Slider
                  step={0.1}
                  my={1}
