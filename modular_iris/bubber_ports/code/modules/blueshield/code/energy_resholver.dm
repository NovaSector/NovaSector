...
/obj/item/gun/energy/e_gun/blueshield
	...
	icon = 'modular_iris/bubber_ports/code/modules/blueshield/icons/energy.dmi'
	icon_state = "blackgrip"
	lefthand_file = 'modular_iris/bubber_ports/code/modules/blueshield/icons/guns_lefthand.dmi'
	righthand_file = 'modular_iris/bubber_ports/code/modules/blueshield/icons/guns_righthand.dmi'
	charge_delay = 9
