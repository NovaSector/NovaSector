...
/client/verb/reportissue()
	...
	if(GLOB.round_id && issue_source != "TG Upstream Issue") // bobaEDIT CHANGE - ORIGINAL: if(GLOB.round_id)
		concatable += ("&round-id=" + GLOB.round_id)

	// Insert testmerges
	if(has_testmerge_data && issue_source != "TG Upstream Issue") // bobaEDIT CHANGE - ORIGINAL: if(has_testmerge_data)
