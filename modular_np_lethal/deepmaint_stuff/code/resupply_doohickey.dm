	...
	product_categories = list(
		list(
			...
			"products" = list(
				...
				/obj/item/scalpel/cruel = INFINITY,
				/obj/item/hemostat/cruel = INFINITY,
				/obj/item/retractor/cruel = INFINITY,
				/obj/item/cautery/cruel = INFINITY,
				/obj/item/circular_saw = INFINITY,
				/obj/item/surgical_drapes = INFINITY,
			),
		),
		list(
			"name" = "Ammunition",
