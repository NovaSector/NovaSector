/obj/effect/spawner/random/epic_loot/deathmatch_armor
	...
	loot = list(
		...
		/obj/effect/spawner/random/lethalstation_armor_set/russia_larp = 1,
...
/obj/effect/spawner/random/lethalstation_armor_set/russia_larp
	loot = list(
...
/obj/effect/spawner/random/epic_loot/deathmatch_funny
	...
	loot = list(
		...
		/obj/item/clothing/shoes/gunboots/dm = 1,
